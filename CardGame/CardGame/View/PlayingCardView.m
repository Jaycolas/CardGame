...
/* override the Card setter*/
- (void)setCard:(PlayingCard *)card
{
    _card = card;
    
    /*If card is changed, possibly it means new card has comes in, so by default we set faceup to FALSE*/
    _faceUp = NO;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.faceUp) {
        ...
        UIImage *faceImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@%@", [self.card rankAsString], self.card.suit]];
        if (faceImage) {
...
- (void)drawCorners
{
    ...
    NSAttributedString *cornerText = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@\n%@", [self.card rankAsString], self.card.suit] attributes:@{ NSFontAttributeName : cornerFont, NSParagraphStyleAttributeName : paragraphStyle }];
